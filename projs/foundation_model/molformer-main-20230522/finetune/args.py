...
def get_parser(parser=None):
    ...
    parser.add_argument("--all-params-ft", action='store_true', help="ft all or not")
    ...
    parser.add_argument("--dims", type=int, nargs="*", default=[150, 50, 50, 2], required=False)
    parser.add_argument(
        "--smiles_embedding",
        type=str,
